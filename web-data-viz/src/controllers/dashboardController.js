...
function pegarDadosGraphicPostDash(req, res) {
    var email = req.params.email;
    var idUser = req.params.idUser;
    var nome = req.params.nome;
        ...
        usuarioModel.autenticarUsuario(email, idUser)
            .then(
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        dashboardModel.pegarDadosGraphicPost()
                            .then((resultadoDadosGraphic) => {
                                res.json({
                                    dataGraphic: resultadoDadosGraphic
                                });
...
function pegarDadosGraphicKpisDash(req, res) {
    var email = req.params.email;
    var idUser = req.params.idUser;
    var nome = req.params.nome;
        ...
        usuarioModel.autenticarUsuario(email, idUser)
            .then(
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        dashboardModel.pegarDadosGraphicKpis()
                            .then((resultadoDadosGraphic) => {
                                res.json({
                                    dataGraphic: resultadoDadosGraphic
                                });
...
module.exports = {
    ...
    pegarDadosGraphicPostDash,
    pegarDadosGraphicKpisDash
}